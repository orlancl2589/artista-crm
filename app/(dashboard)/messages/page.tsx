  ...
  return (
    <div className="flex-1 overflow-y-auto p-6">
      <div className="flex items-center gap-3 mb-8 pb-5" style={{ borderBottom: '1px solid var(--border)' }}>
        ...
        <div>
          <h1 className="text-[17px] font-bold" style={{ color: 'var(--text)' }}>Mensajes</h1>
          <p className="font-mono text-[11px] mt-[2px]" style={{ color: 'var(--muted2)' }}>Bandeja unificada de canales</p>
        </div>
      </div>
